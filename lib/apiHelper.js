...
export const getEmployeeDashboard = (token, employeeId, compid) => {
    console.log(`calling getEmployeeStatus =${employeeId}`, { CompanyId: compid, EmployeeId: employeeId });
    return makePostRequest(`api/accounts/GetEmployeeDashboard?employeeId=${employeeId}`, { CompanyId: compid, EmployeeId: employeeId },token);
};
